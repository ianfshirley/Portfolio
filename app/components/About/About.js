...
export default function About() {
  return (
    <div className="m-8 md:m-24 flex flex-col md:flex-row justify-center items-center">
      <div className="mask mask-hexagon max-w-xs md:max-w-md bg-gradient-to-br from-peach-500 to-peach-300 z-10 -mr-8">
        <Image
          src={profilePic}
      ...
      <div className="flex flex-col justify-center z-0">
        ...
        <p className="pl-10 sm:pl-20 mx-4 pr-10 py-5 sm:-ml-10 text-justify max-w-2xl  rounded-r-lg text-mist-50 bg-army-400 rounded-2xl">
