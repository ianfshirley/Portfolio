...
export default function About() {
  return (
    ...
    >
      <div
        className="mask mask-hexagon max-w-xs md:max-w-md bg-gradient-to-br from-peach-500 to-peach-300 z-10 sm:-mr-8 mt-10"
      >
        <Image
          src={profilePic}
      ...
      >
        <h5
          className="text-army text-2xl pl-5 pr-5 pb-5 sm:pt-5 text-center"
        >
          a little about me
        </h5>
        <div
          className="px-6 sm:px-10 mx-4  py-5 sm:-ml-2 text-justify max-w-2xl  rounded-r-lg text-mist-50 bg-army rounded-2xl"
        >
          <p className="py-2">
